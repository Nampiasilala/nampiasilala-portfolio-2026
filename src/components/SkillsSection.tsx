...
const competences: Skill[] = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: "Utilisation du terminal Linux", level: 4 },
  ...
  },
  {
    ...
    technologies: [
      { name: "Notions de cybersécurité", level: 3 },
      { name: "Bases de la sécurité réseau", level: 3 },
      { name: "Bonne pratique de sécurité numérique", level: 4 },
    ],
    modes: ["cyber"],
  },
  {
    ...
    technologies: [
      { name: "TCP/IP & OSPF/BGP", level: 3 },
      { name: "SIP / IMS (VoIP)", level: 2 },
      { name: "APN / IPBX", level: 3 },
  ...
  },
  {
    ...
    technologies: [
      { name: "Arduino / ESP32", level: 3 },
      { name: "Proteus Professional", level: 4 },
      { name: "Composant électronique", level: 3 },
    ],
    modes: ["electronique"],
  },
  {
